...
class EventController {
    ...
    public function create() {
        ...
        if (isPost()) {
            ...
            if (!$title || !$event_dt || !$end_dt) {
                ...
                if (!empty($_FILES['banner_image']['name'])) {
                    $banner = uploadFile($_FILES['banner_image'], 'public/uploads/');
                }
        ...
        $db->close();
        require 'views/event/create.php';
    }
    ...
    public function edit() {
        ...
        if (isPost()) {
            ...
            if (!empty($_FILES['banner_image']['name'])) {
                $newBanner = uploadFile($_FILES['banner_image'], 'public/uploads/');
            ...
            $stmt3->bind_param("ssiissssi i", $title, $description, $category_id, $venue_id, $venue_override, $event_dt, $end_dt, $banner, $event_id, $org_id);
            $stmt3->execute();
            $db->close();
    ...
    public function changeStatus() {
        ...
        // Notify attendees on cancellation via announcements
        if ($status === 'cancelled') {
