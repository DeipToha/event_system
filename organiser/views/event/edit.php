...
<div class="card">
    ...
    <form method="POST" action="index.php?page=events&action=edit&id=<?= $event['id'] ?>" enctype="multipart/form-data">
        <div class="form-grid mb-2">
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" name="event_datetime" class="form-control" value="<?= date('Y-m-d\TH:i', strtotime($event['event_datetime'])) ?>" required>
            </div>
            <div class="form-group">
